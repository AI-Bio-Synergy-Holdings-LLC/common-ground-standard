...
Unless a file says otherwise, the materials in this repository are made available under the Apache License, Version 2.0. See [LICENSE](LICENSE).

This license allows use, copying, modification, and distribution of the repository materials under the terms of Apache-2.0.

## No Trademark Rights

The Apache-2.0 license does not grant permission to use project names, trade names, service marks, logos, certification marks, or other source-identifying marks except as required for reasonable attribution.

Names and marks that remain controlled include, without limitation:

- Common Ground Standard
- Pivot
- Pivot Common Ground Partnership
- Common Ground Resilience Network
- CGRN
- DividendOS
- Equilogos
...
This repository contains review drafts. It does not create a certification program, certification mark license, conformance approval, or right to claim that any project is certified or aligned.

Certification, if developed later, will require formal criteria, evidence, governance records, and review.
